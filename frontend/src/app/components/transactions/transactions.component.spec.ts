...
import { of } from 'rxjs';
import { AppDataService } from '../../services/data-service/data.service'; // Adjust the import path as necessary
...
describe('TransactionsComponent', () => {
  ...
  beforeEach(async () => {
    ...
    mockAppDataService = jasmine.createSpyObj('AppDataService', ['getTransactions']);
    ...
    mockAppDataService.getTransactions.and.returnValue(of([{ /* transaction data */ }]));
  ...
  it('should show a message when no transactions are available', () => {
    ...
    fixture.detectChanges();
    const msgElement = fixture.debugElement.query(By.css('.no-transactions-msg'));
